...
.list-group-item table thead tr th, .infoWindow table thead tr th{
 color: black;
}
...
.infowindow-assessment-container{
      height: 100px;
}

.list-group-item:hover, .list-group-item.Good:hover, .list-group-item.Poor:hover,.list-group-item.Fair:hover, .list-group-item.Excellent:hover, .active {
...
.site-quality.Good, .site-quality.Excellent{
  color: #3c763d;
  background-color: #dff0d8;
  border-bottom: 1px solid #b9cea8;
}
