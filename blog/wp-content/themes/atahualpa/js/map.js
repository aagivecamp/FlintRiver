...
function addListItem(marker,index){
    ...
    if(marker.assessments){
        ...
        html += "<span class='site-name'><img class='icon' src='http://flintriver.org/images/icon.png'>" + marker.site_name +"</span><div class='site-quality "+grade+"'><span class='site-score'>"+marker.assessments[0].stream_quality_score+"</span> <span class='site-grade'>"+grade+"</span></div>";
    ...
    // html += "</table>";
         ...
         html += '<div  class="list-group-item" data-index="'+index+'">';
        html += "<span class='site-name'><img class='icon' src='http://flintriver.org/images/icon.png'>" + marker.site_name +"</span><div class='site-quality na'><span class='site-score'>N/A</span> <span class='site-grade'></span></div><div class='vol-link'><a href='http://flintriver.org/blog/become-a-volunteer/'>We need your help to assess this site!</a></div>";
    }
    html += "</div>";
